...
interface EntityRepository {
    ...
    /**
     * Функция, которая проверяет, есть ли [entity] в базе данных, и, если есть, возвращает её id
     * @param entity элемент, который нужно найти
     * @param resultAction лямбда функция, куда передается результат выполнения.
     * Если результат успешный, но значение = null, это значит, что совпадений в базе данных не нашлось.
     */
