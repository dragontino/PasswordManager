...
//        fab.setBackgroundTintList(ColorStateList.valueOf(support.getHeaderColor()));
//        navigationView.setBackgroundColor(support.getBackgroundColor());
//
//        headerLayout = findViewById(R.id.nav_header_main);
//
...
//            else
//                headerLayout.setBackgroundColor(support.getHeaderColor());
//        }
//    }
//
//    @Override
