...
import com.security.passwordmanager.presentation.view.theme.AnimationConstants.animationTimeMillis
import com.security.passwordmanager.presentation.view.theme.AnimationConstants.contentDurationRatio
import com.security.passwordmanager.presentation.view.theme.AnimationConstants.screenEnterExitRatio
...
object AnyScreenAnimation : EnterExitAnimation {
...
object ScreenContentAnimation : EnterExitAnimation {
    override val enterTimeMillis = animationTimeMillis
...
object ScreenToolbarAnimation : EnterExitAnimation {
...
object NotesScreenAnimations {
    object ScrollFabAnimation : EnterExitAnimation {
        override val enterTimeMillis = animationTimeMillis
    ...
    object ScreenFabAnimation : EnterExitAnimation {
        override val enterTimeMillis = animationTimeMillis
        override val exitTimeMillis = animationTimeMillis
    ...
    object ListItemAnimation : EnterExitAnimation {
...
object SearchScreenAnimation : EnterExitAnimation {
    override val enterTimeMillis = ScreenContentAnimation.enterTimeMillis * 2
    override val exitTimeMillis = ScreenContentAnimation.enterTimeMillis

    override val enter = slideInHorizontally(
        animationSpec = tween(
            durationMillis = enterTimeMillis / 2,
            delayMillis = enterTimeMillis / 2,
            easing = LinearOutSlowInEasing
        ),
        initialOffsetX = { it }
    )
...
object WebsiteScreenFabAnimation : EnterExitAnimation {
    override val enterTimeMillis = animationTimeMillis
    override val exitTimeMillis = animationTimeMillis
