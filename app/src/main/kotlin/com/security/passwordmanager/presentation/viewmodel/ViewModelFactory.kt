...
class ViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>, extras: CreationExtras): T {
        ...
        when {
            ...
            modelClass.isAssignableFrom(AllNotesViewModel::class.java) -> {
            ...
            modelClass.isAssignableFrom(PasswordGenerationViewModel::class.java) ->
                return PasswordGenerationViewModel(
                    repository = PasswordGenerationRepository(application)
                ) as T
