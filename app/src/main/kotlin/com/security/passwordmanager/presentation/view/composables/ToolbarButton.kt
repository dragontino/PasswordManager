...
@Composable
fun CollapsingToolbarScope.ToolbarButton(
    icon: ImageVector,
    ...
    val borderColor =
        colors.borderColor + colors.transparentBorderColor ratio state.contentScrollProgress

    OutlinedIconButton(
        onClick = onClick,
        colors = colors.convertToIconButtonColors(alpha = state.contentScrollProgress),
        shape = CircleShape,
        enabled = enabled,
